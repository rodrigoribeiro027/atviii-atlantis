...
import CadastroPassaport from "./cadastroPassaport";
import CadastroPessoaFisica from "./cadastroPessoaF";
        ...
        while (this.execucao) {
            ...
            switch (this.opcao) {
                case 1:
                    ...
                    break
                case 2:
                    this.processo = new CadastroPessoaFisica(this.cliente)
                    this.processo.processar()
                    break
                case 3:
                    this.processo = new CadastroPassaport(this.cliente)
                    this.processo.processar()
                    break
                case 0:
                    this.execucao = false
